    ...
    return (
        <div className="p-4 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Edit Appointment</h1>
                    <p className="text-sm md:text-base text-gray-600">Update appointment information</p>
                </div>
                <Link href="/admin/appointments" className="w-full sm:w-auto">
            ...
            <form onSubmit={handleSubmit} className="max-w-4xl">
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-100 mb-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div>
                            <div className="text-base sm:text-lg font-bold text-gray-900">{appointment.patientName}</div>
                            <div className="text-xs text-gray-600">Patient</div>
                        </div>
                        <div>
                            <div className="text-base sm:text-lg font-bold text-gray-900">{new Date(appointment.date).toLocaleDateString()}</div>
                            <div className="text-xs text-gray-600">Date</div>
                        </div>
                        <div>
                            <div className="text-base sm:text-lg font-bold text-gray-900">{appointment.time}</div>
                ...
                <div className="bg-white rounded-xl p-4 sm:p-6 border border-gray-100 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3 pt-4 border-t border-gray-100">
                        <button
                            ...
                            className="w-full sm:w-auto px-6 py-3 bg-[#00d4aa] text-white rounded-lg hover:bg-[#00bfa6] transition-colors font-medium flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isSubmitting ? (
                                <>
                        ...
                        <Link href="/admin/appointments" className="w-full sm:w-auto">
                            <button
                                type="button"
                                className="w-full sm:w-auto px-6 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors font-medium border border-gray-200"
                            >
                                Cancel
                            </button>
                        </Link>

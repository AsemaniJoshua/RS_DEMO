        ...
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    <Link href={`/admin/blog/${blog.id}/edit`} className="w-full sm:w-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-8">
                        <div className="mb-6">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{blog.title}</h2>
                        ...
                        <div className="prose prose-blue max-w-none text-gray-700 bg-gray-50/50 p-4 sm:p-6 rounded-xl border border-gray-100 overflow-x-auto break-words">

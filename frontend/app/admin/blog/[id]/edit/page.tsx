            ...
            <form onSubmit={handleSubmit} className="max-w-4xl">
                <div className="bg-white rounded-xl p-6 border border-gray-100 space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                        <h3 className="text-sm font-semibold text-gray-900 mb-3">Post Statistics</h3>
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                <div className="text-2xl font-bold text-gray-900">{post.publishDate || "Not published"}</div>
                                <div className="text-xs text-gray-600">Publish Date</div>
                            </div>
                            <div>
                                <div className="text-2xl font-bold text-gray-900">{post.author}</div>

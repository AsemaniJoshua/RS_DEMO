    ...
    return (
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    <Link href={`/admin/courses/${course.id}/edit`} className="w-full sm:w-auto">
                        <button className="w-full sm:w-auto px-5 py-2.5 bg-[#00d4aa] text-white rounded-xl hover:bg-[#00bfa6] transition-colors font-medium flex items-center justify-center gap-2 shadow-sm shadow-teal-500/20">
            ...
            {course.thumbnailUrl ? (
                ...
                <div className="mb-8 bg-linear-to-br from-[#00d4aa] to-[#00bfa6] rounded-2xl border border-gray-100 shadow-sm h-48 md:h-64 flex flex-col items-center justify-center text-white p-4 text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-8">
                        <div className="mb-6">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{course.title}</h2>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8 p-4 bg-gray-50 rounded-xl border border-gray-100">
                            <div>
                        ...
                        <div 
                            className="prose prose-blue max-w-none text-gray-700 overflow-x-auto break-words"

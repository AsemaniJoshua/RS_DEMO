    ...
    return (
        <div className="p-4 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Edit Course</h1>
                    <p className="text-sm md:text-base text-gray-600">Update course details and content</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-4 sm:p-6 border border-gray-100 space-y-6">
                    ...
                    <div>
                        ...
                        <FileUpload
                            ...
                            onRemove={() => { setCourseFile(null); setExistingFile(""); }}
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3 pt-4 border-t border-gray-100">
                        <button
                            type="submit"
                            disabled={submitting}
                            className="w-full sm:w-auto px-6 py-3 bg-[#00d4aa] text-white rounded-lg hover:bg-[#00bfa6] transition-colors font-medium disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                            {submitting && (

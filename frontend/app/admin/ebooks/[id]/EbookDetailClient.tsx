...
export default function EbookDetailClient() {
    ...
    const fetchEbook = async (ebookId: string) => {
        try {
            setIsLoading(true);
            const response = await ebookService.getAdminEbookById(ebookId);
    ...
    return (
        <div className="p-4 md:p-8 max-w-5xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    <div>
                        <div className="flex flex-wrap items-center gap-3 mb-2">
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">{ebook.title}</h1>
                        ...
                        <p className="text-base sm:text-lg text-gray-600">by {ebook.author}</p>
                    </div>

                    <div className="flex items-center gap-3 w-full sm:w-auto">
                        <Link href={`/admin/ebooks/${ebook.id}/edit`} className="w-full sm:w-auto">
                            <button className="w-full sm:w-auto px-4 py-2 bg-[#00d4aa] text-white rounded-lg hover:bg-[#00bfa6] transition-colors font-medium flex items-center justify-center gap-2">
                        ...
                        <button
                            ...
                            disabled={isDeleting}
                            className="w-full sm:w-auto px-4 py-2 border border-red-200 text-red-600 rounded-lg hover:bg-red-50 transition-colors font-medium flex items-center justify-center gap-2 disabled:opacity-50"
                        >
                            {isDeleting ? (
            ...
            <div className="mb-8 bg-white rounded-xl p-1 border border-gray-100 shadow-sm overflow-hidden">
                <div className="h-64 sm:h-96 rounded-lg overflow-hidden bg-gray-100 relative">
                     {ebook.coverImage ? (
                        <img 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-xl p-4 sm:p-6 border border-gray-100 shadow-sm">
                        ...
                        {ebook.description ? (
                            <div 
                                className="prose prose-blue max-w-none text-gray-600 overflow-x-auto break-words"

...
export default function EditEbookClient() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await ebookService.updateEbook(id, dataToSend);
        ...
        <div className="p-4 md:p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Edit Ebook</h1>
                        <p className="text-sm text-gray-600">Update ebook details and files</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                {/* Submit Buttons */}
                <div className="flex flex-col sm:flex-row items-center justify-end gap-3 sm:gap-4 pt-4 border-t border-gray-100">
                    <Link href={`/admin/ebooks/${id}`} className="w-full sm:w-auto">
                        <button
                            type="button"
                            className="w-full sm:w-auto px-6 py-3 border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium"
                        >
                            Cancel
                        </button>
                    </Link>
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full sm:w-auto px-8 py-3 bg-[#00d4aa] text-white rounded-lg hover:bg-[#00bfa6] transition-all shadow-lg shadow-[#00d4aa]/20 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                        {isLoading ? (
                            <>

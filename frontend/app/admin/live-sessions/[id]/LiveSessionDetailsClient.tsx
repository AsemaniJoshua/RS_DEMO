        ...
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
            ...
            <div className="mb-6">
                <Link 
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg shadow-sm transition-colors font-medium mb-4 text-sm"
                >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <div className="flex flex-wrap items-center gap-3 mt-2">
                            ...
                            <span className="text-gray-600 text-sm">{formatDate(session.scheduled_date)} at {formatTime(session.scheduled_date)}</span>
                        </div>
                    </div>
                    <Link
                        href={`/admin/live-sessions/${sessionId}/edit`}
                        className="px-4 py-2 bg-[#0066ff] text-white rounded-lg hover:bg-[#0052cc] transition-colors text-center font-medium"
                    >
                        Edit Session
                    </Link>
                </div>
                        ...
                        <div>
                            ...
                            {session.meeting_link ? (
                                <a 
                                    ...
                                    target="_blank" 
                                    rel="noreferrer"
                                    className="text-[#0066ff] hover:underline flex items-center gap-1 mt-1 break-all"
                                >
                                    Join Meeting

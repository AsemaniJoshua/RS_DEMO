...
export default function EditLiveSessionClient() {
            ...
            <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex gap-2">
                    <Link 
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg shadow-sm transition-colors font-medium text-sm"
                    >
                    ...
                    <Link
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg shadow-sm transition-colors font-medium text-sm"
                        title="View Session"
                    >
                ...
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Edit Live Session</h1>
                    <p className="text-sm text-gray-600 mt-1">Update session information and settings</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 space-y-6">
                ...
                <div>
                    ...
                    <RichTextEditor
                        ...
                        onChange={(value) => setSession({...session, description: value})}
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
                    <Link
                        href={`/admin/live-sessions/${sessionId}`}
                        className="w-full sm:flex-1 px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-center font-medium"
                    >
                        Cancel
                    </Link>
                    <button
                        type="submit"
                        disabled={saving}
                        className="w-full sm:flex-1 px-6 py-3 bg-[#0066ff] text-white rounded-lg hover:bg-[#0052cc] transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                    >

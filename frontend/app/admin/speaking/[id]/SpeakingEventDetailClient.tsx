        ...
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    <Link href={`/admin/speaking/${eventId}/edit`} className="w-full sm:w-auto">
                        <button className="w-full sm:w-auto px-5 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 transition-colors font-medium flex items-center justify-center gap-2 shadow-sm">
                    ...
                    <button 
                        ...
                        className="w-full sm:w-auto px-5 py-2.5 bg-red-50 text-red-600 border border-red-100 rounded-xl hover:bg-red-100 transition-colors font-medium flex items-center justify-center gap-2"
                    >
                ...
                <div className="lg:col-span-2 space-y-6 min-w-0">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-8">
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
                            <div>
                                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{event.title}</h2>
                                <p className="text-gray-500 text-base sm:text-lg">{event.venue}</p>
                            </div>
                    ...
                    {/* Description */}
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-8 overflow-hidden">

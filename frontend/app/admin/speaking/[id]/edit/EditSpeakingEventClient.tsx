...
export default function EditSpeakingEventClient() {
    ...
    return (
        <div className="p-4 md:p-8">
            ...
            <form onSubmit={handleSubmit} className="max-w-3xl">
                <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-6 md:p-8 space-y-6">
                    {/* Event Title */}
                    <div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6">
                    <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto">
                        <button
                            ...
                            className="w-full sm:w-auto px-8 py-3 bg-[#00d4aa] text-white rounded-lg hover:bg-[#00bfa6] transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isSubmitting ? "Updating..." : "Update Event"}
                        </button>
                        <Link
                            href="/admin/speaking"
                            className="w-full sm:w-auto px-8 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium text-center"
                        >
                            Cancel
                        </Link>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto px-6 py-3 border border-red-200 text-red-600 rounded-lg hover:bg-red-50 transition-colors font-medium text-center"
                    >
                        Delete Event
                    </button>
                </div>

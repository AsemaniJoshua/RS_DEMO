...
export default function NewSpeakingEngagementPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        console.log("New speaking engagement:", formData);
    ...
    return (
        <div className="p-8">
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Add Speaking Engagement</h1>
                    <p className="text-gray-600">Create a new speaking engagement or event</p>
                </div>

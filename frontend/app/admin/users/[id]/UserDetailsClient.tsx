...
export default function UserDetailsClient() {
    ...
    return (
        <div className="p-4 md:p-8 max-w-5xl mx-auto">
            ...
            {/* Profile Header Card */}
            <div className="bg-white rounded-2xl p-4 sm:p-8 border border-gray-100 shadow-sm mb-8 flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-linear-to-br from-[#00d4aa] to-[#00bfa6] flex items-center justify-center text-white text-3xl md:text-4xl font-bold shrink-0 shadow-lg ring-4 ring-white">
                ...
                <div className="flex-1 text-center md:text-left space-y-4 w-full">
                    <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-4">
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{user.first_name} {user.last_name}</h1>
                        ...
                        <div className="flex gap-3 w-full md:w-auto">
                            <Link href={`/admin/users/${user.id}/edit`} className="w-full md:w-auto">
                                <button className="w-full md:w-auto px-4 py-2 border border-gray-200 rounded-lg hover:bg-gray-50 text-gray-700 font-medium transition-colors flex items-center justify-center gap-2">
                ...
                <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-6">
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-100 mb-6">
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-xs text-gray-400 font-mono bg-white px-2 py-1 rounded border border-gray-200 select-all break-all">{user.id}</span>
                        </div>

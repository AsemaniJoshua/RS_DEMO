    ...
    return (
        <div className="p-4 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Edit User</h1>
                    <p className="text-sm md:text-base text-gray-600">Update user information and permissions</p>
                </div>
            ...
            <form onSubmit={handleSubmit} className="max-w-4xl">
                    ...
                    <div className="bg-white rounded-xl p-4 sm:p-6 border border-gray-100 mb-6">
                        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-center sm:text-left">
                            <div className="w-20 h-20 rounded-full bg-linear-to-br from-[#00d4aa] to-[#00bfa6] flex items-center justify-center text-white text-2xl font-bold shrink-0">
                                {getInitials(user!.first_name, user!.last_name)}
                            </div>
                            <div className="flex-1">
                                <h3 className="text-xl font-bold text-gray-900">{user!.first_name} {user!.last_name}</h3>
                                <p className="text-gray-600">{user!.email}</p>
                                <div className="flex flex-wrap justify-center sm:justify-start gap-2 sm:gap-4 mt-2 text-sm">
                ...
                <div className="bg-white rounded-xl p-4 sm:p-6 border border-gray-100 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3 pt-4 border-t border-gray-100">
                        <button
                            ...
                            className="w-full sm:w-auto px-6 py-3 bg-[#00d4aa] text-white rounded-lg hover:bg-[#00bfa6] transition-colors font-medium disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {isSubmitting ? (
                                <>

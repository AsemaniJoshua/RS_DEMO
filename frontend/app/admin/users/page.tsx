            ...
            <div className="block md:hidden space-y-4">
                {filteredUsers.length === 0 ? (
                    ...
                    filteredUsers.map((user) => (
                        <div key={user.id} className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm space-y-3">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#00d4aa] to-[#00bfa6] flex items-center justify-center text-white font-semibold shrink-0">
                            ...
                            <div className="flex flex-wrap gap-2 pt-1">
                                ...
                                <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(user.account_status)}`}>
                                    {user.account_status}
                                </span>
                            </div>

                ...
                <div className="mx-auto max-w-[1400px] px-12">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed">
                            Book your personalized health consultation in just a few clicks. Choose your service, pick a convenient time, and get started.
                        </p>
                    </div>
                </div>
            </section>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                required
                                                className="w-full h-12 px-4 rounded-lg border-2 border-gray-200 focus:border-[#0066ff] focus:outline-none"
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            onChange={handleChange}
                                            rows={4}
                                            className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-[#0066ff] focus:outline-none resize-none"

...
export default function DashboardAppointmentClient() {
    ...
    useEffect(() => {
        ...
        const fetchAppointment = async () => {
            try {
                const data = await appointmentService.getMyAppointmentById(appointmentId);
                setAppointment(data);
            } catch (error) {
                ...
                <div className="lg:col-span-2 space-y-6 min-w-0">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-8">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h3 className="text-lg font-bold text-gray-900">Appointment Context</h3>
                        </div>

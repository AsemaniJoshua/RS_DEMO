...
export default function DashboardBlogDetailClient() {
    ...
    const fetchBlog = async (blogId: string) => {
        try {
            const data = await userBlogService.getBlogById(blogId);
            if (data) {
                setBlog(data);
            }
        } catch (error) {
        ...
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6 min-w-0">
                    {/* Content Card */}
                    <article className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-8 overflow-hidden">
                        {/* Meta */}
                        ...
                        {blog.excerpt && (
                            <div 
                                className="text-[#4b5563] text-base md:text-lg italic mb-8 pb-6 border-b border-gray-100 prose prose-sm max-w-none overflow-x-auto break-words"
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-full bg-linear-to-br from-blue-500 to-cyan-400 flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-blue-500/20">

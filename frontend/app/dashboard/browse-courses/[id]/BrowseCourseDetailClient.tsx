...
export default function BrowseCourseDetailClient() {
        ...
        <div className="p-4 md:p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <div className="p-4 sm:p-6">
                            ...
                            {(course.rating || course.students) && (
                                <div className="flex flex-wrap items-center gap-6 text-sm text-gray-600 border-t border-gray-200 pt-4">
                                    {course.rating && (
                ...
                <div className="space-y-6">
                    {/* Enrollment Card */}
                    <div className="bg-white rounded-xl p-4 sm:p-6 border border-gray-200 sticky top-6">
                        {course.isPurchased ? (
                            <button

        ...
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-8">
                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
                            <div className="flex-1">
                                ...
                                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">{ebook.title}</h1>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mt-8">
                            <div className="flex items-start gap-3 p-3 sm:p-4 bg-gray-50 rounded-xl">
                                <div className="p-2 sm:p-3 bg-white rounded-lg shadow-sm text-blue-600 shrink-0">
                                    <Calendar className="w-5 h-5 sm:w-6 sm:h-6" />
                                </div>
                                <div>
                                    <div className="text-xs sm:text-sm text-gray-500 font-medium mb-1">Published</div>
                            ...
                            <div className="flex items-start gap-3 p-3 sm:p-4 bg-gray-50 rounded-xl">
                                <div className="p-2 sm:p-3 bg-white rounded-lg shadow-sm text-purple-600 shrink-0">
                                    <BookOpen className="w-5 h-5 sm:w-6 sm:h-6" />
                                </div>
                                <div>
                                    <div className="text-xs sm:text-sm text-gray-500 font-medium mb-1">Pages</div>
                                    <div className="font-bold text-gray-900 text-sm sm:text-base">{ebook.pages || 'N/A'}</div>
                                </div>
                            </div>

                            <div className="flex items-start gap-3 p-3 sm:p-4 bg-gray-50 rounded-xl">
                                <div className="p-2 sm:p-3 bg-white rounded-lg shadow-sm text-orange-600 shrink-0">
                                    <FileText className="w-5 h-5 sm:w-6 sm:h-6" />
                                </div>
                                <div>
                                    <div className="text-xs sm:text-sm text-gray-500 font-medium mb-1">Format</div>
                                    <div className="font-bold text-gray-900 text-sm sm:text-base">{ebook.format || 'PDF'}</div>
                                </div>
                            </div>

                            <div className="flex items-start gap-3 p-3 sm:p-4 bg-gray-50 rounded-xl">
                                <div className="p-2 sm:p-3 bg-white rounded-lg shadow-sm text-green-600 shrink-0">
                                    <Globe className="w-5 h-5 sm:w-6 sm:h-6" />
                                </div>
                                <div>
                                    <div className="text-xs sm:text-sm text-gray-500 font-medium mb-1">Language</div>
                    ...
                    {/* Action Section */}
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-100 shadow-sm p-4 sm:p-8">
                        {isPurchased ? (
                            <>

...
export default function DashboardLiveSessionDetailClient() {
    ...
    return (
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
            ...
            {/* Hero Banner */}
            <div className="mb-8 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-100 shadow-sm p-4 sm:p-8 md:p-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-8">
                        ...
                        {session.description ? (
                            <p className="text-gray-700 whitespace-pre-line leading-relaxed overflow-x-auto break-words">

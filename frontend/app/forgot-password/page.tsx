            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#00d4aa] via-[#00bfa6] to-teal-600 p-12 flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-xl text-white/90 leading-relaxed max-w-md">
                        Don't worry! We'll help you get back into your account securely in just a few simple steps.
                    </p>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-gray-50">
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 text-lg">Enter your email to receive a verification code</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3.5 bg-white border border-gray-300 rounded-lg focus:border-[#00d4aa] focus:ring-2 focus:ring-[#00d4aa]/20 outline-none transition-all text-gray-900 placeholder:text-gray-400 text-lg"
                            />
                        </div>
                    ...
                    <p className="mt-8 text-center text-sm text-gray-500">
                        Need help?{" "}
                        <Link href="/contact" className="text-[#00d4aa] hover:underline font-semibold">
                            Contact Support
                        </Link>
                    </p>
                </div>

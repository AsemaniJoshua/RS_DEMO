                            ...
                            <div className="flex sm:justify-center flex-nowrap items-center gap-3 px-4 py-2 min-w-max">
                                {categories.map((category, index) => (
                                    <button
                                        ...
                                        className={`h-10 px-6 rounded-full text-sm font-semibold transition-all duration-300 transform active:scale-95 cursor-pointer ${
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 min-w-0">
                            {events.map((event) => (
                                <div 
                                    ...
                                    className="bg-white rounded-3xl p-6 border-2 border-gray-100 hover:border-[#0066ff] hover:shadow-xl hover:shadow-[#0066ff]/5 hover:-translate-y-1 transition-all duration-300 cursor-pointer min-w-0 flex flex-col justify-between group"
                                >
                                    <div className="min-w-0">
                                        {event.image ? (
                                            <div className="relative w-full h-48 mb-6 rounded-2xl overflow-hidden bg-gradient-to-br from-[#E0F2FE] to-[#f0f9ff]">
                                                <Image
                                                    src={event.image}
                                                    alt={event.title}
                                                    fill
                                            ...
                                            <div className="relative w-full h-48 mb-6 rounded-2xl overflow-hidden bg-gradient-to-br from-[#E0F2FE] to-[#f0f9ff] flex items-center justify-center">
                                        ...
                                        <div className="flex items-start gap-4 mb-4 min-w-0">
                                            <div className="w-12 h-12 bg-gradient-to-br from-[#0066ff] to-[#00bfa6] rounded-xl flex items-center justify-center flex-shrink-0 text-white shadow-md shadow-[#0066ff]/10">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <h3 className="font-bold text-gray-950 mb-1 leading-snug line-clamp-2 break-words [word-break:break-word] group-hover:text-[#0066ff] transition-colors duration-200">{event.title}</h3>
                                                <p className="text-sm text-[#0066ff] font-semibold break-words [word-break:break-word]">{event.venue}</p>
                                            </div>
                                        </div>

                                        {event.description && (
                                            <p className="text-sm text-gray-600 mb-6 line-clamp-3 break-words [word-break:break-word] leading-relaxed">
                                    ...
                                    <div className="mt-auto">
                                        <div className="flex flex-wrap items-center gap-y-2 gap-x-4 pt-4 border-t border-gray-100 text-xs text-gray-500">
                                            ...
                                            <span className="flex items-center gap-1.5 font-medium break-words [word-break:break-word]">
                                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-gray-400">
                                        ...
                                        {event.category && (
                                            <div className="mt-4 flex">
                                                <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-[#E0F2FE] text-[#0066ff]">
                                                    {event.category}
                                                </span>
                                            </div>
                                        )}

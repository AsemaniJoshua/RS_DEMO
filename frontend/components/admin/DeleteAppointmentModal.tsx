...
interface DeleteAppointmentModalProps {
    isOpen: boolean;
    appointmentName: string; // Patient name or Date/Time representation
    isDeleting?: boolean;
    error?: string;
    onConfirm: () => void;
    onCancel: () => void;
...
export default function DeleteAppointmentModal({ isOpen, appointmentName, isDeleting = false, error, onConfirm, onCancel }: DeleteAppointmentModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl transform transition-all">
                ...
                <p className="text-gray-600 text-center mb-6">
                    Are you sure you want to delete the appointment for <span className="font-semibold text-gray-900">"{appointmentName}"</span>? This action cannot be undone.
                </p>

                {/* Warning Box */}
                <div className="border border-red-200 bg-red-50 rounded-lg p-4 mb-6">
                    <div className="flex gap-3">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="shrink-0 mt-0.5 text-red-600">
                        ...
                        <div>
                            ...
                            <ul className="text-sm text-red-700 space-y-1">
                                <li>• Remove appointment from schedule</li>
                                <li>• Delete appointment records</li>
                                <li>• Free up the time slot</li>
                            </ul>
                        </div>
                    </div>
                </div>

...
export default function DeleteMediaModal({ isOpen, fileName, isDeleting = false, onConfirm, onCancel }: DeleteMediaModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl transform transition-all">
                ...
                <p className="text-gray-600 text-center mb-6">
                    Are you sure you want to delete <span className="font-semibold text-gray-900">"{fileName}"</span>? This action cannot be undone.
                </p>

                {/* Warning Box */}
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                    <div className="flex gap-3">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-red-600 shrink-0 mt-0.5">
                        ...
                        <div>
                            ...
                            <ul className="text-sm text-red-700 space-y-1">
                                <li>• Remove file from media library</li>
                                <li>• Break any links using this file</li>
                                <li>• Delete file from server storage</li>
                            </ul>
                        </div>
                    </div>
                </div>
